...
export const agents: Agent[] = [
  {
    ...
    longDescription:
      "Transforma tu servicio al cliente con un agente de IA que nunca duerme. Capaz de manejar múltiples conversaciones simultáneamente, escalar casos complejos y aprender de cada interacción para mejorar continuamente. Integra con tus sistemas existentes de tickets y CRM.",
  ...
  },
  {
    ...
    longDescription:
      "Tu departamento de marketing potenciado por IA. Genera contenido para redes sociales, email marketing y blog. Optimiza campañas en tiempo real basándose en datos de rendimiento. Sugiere estrategias basadas en tendencias del mercado y comportamiento de tu audiencia.",
    category: "Marketing",
    price: 69,
    icon: "Megaphone",
    features: [
  ...
  },
  {
    ...
    longDescription:
      "Revoluciona la gestión de talento en tu empresa. Desde el screening inicial de CVs hasta el onboarding completo de nuevos empleados. Automatiza las tareas repetitivas de RRHH para que tu equipo se enfoque en lo que realmente importa: las personas.",
  ...
  },
  {
    ...
    longDescription:
      "Convierte tus datos en decisiones accionables. Este agente conecta con tus fuentes de datos, genera reportes automáticos y detecta patrones que humanos podrían pasar por alto. Visualizaciones claras y alertas inteligentes cuando algo requiere tu atención.",
    category: "Analítica",
    price: 89,
    icon: "BarChart3",
    features: [
  ...
  },
  {
    ...
    longDescription:
      "Simplifica la gestión financiera de tu empresa. Automatiza la facturación, categoriza gastos automáticamente, reconcilia cuentas y genera reportes financieros listos para presentar. Mantén el control total de la salud financiera de tu negocio.",
    category: "Finanzas",
    price: 99,
    icon: "DollarSign",
    features: [
